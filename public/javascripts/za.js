 ...
 *
 * TSZOMBIECOOKIE
 * The API for storing persistent cookie in client browser
 * Author: SonLT - thaison.official@gmail.com - sonlt@vng.com.vn
 *
 * ===== USAGE =====
 * // initialize a variable from the class
 * var zombieCookie = TsZombieCookie();
 *
 * // set a cookie value
 * // (optional) cookieExprDays means the number of days the cookie will last
 * zombieCookie.setCookie(cookieName, cookieValue, cookieExprDays);
 *
 * // get the cookie value
 * // this is an asynchronous function
 * // remember to provide the callback function to get the cookieValue
 * zombieCookie.getCookie(cookieName, function(result){
 *   console.log("cookieValue: " + result);
 * });
 *
 * // remove the cookie value
 * zombieCookie.removeCookie(cookieName);
 *
 * =====*=====
 * Please checkout the newest version on my github repo: https://github.com/thaisonle94/ts-zombie-cookie
 */
